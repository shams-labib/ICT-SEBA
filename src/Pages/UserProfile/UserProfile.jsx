...
const UserProfile = () => {
  ...
  const userData = {
    ...
    phone: profileData?.phone || "017840000",
    photoURL:
      user?.photoURL ||
  ...
  const stats = [
    ...
    {
      label: "মোট ক্লাস",
      value: userData?.totalClasses || 0,
      icon: <BookOpen size={18} className="text-purple-500" />,
    },
    {
      label: "সময় ব্যয়",
      value: userData?.studyHours || "0h",
            ...
            <div className="card bg-white p-6 shadow-md border border-slate-100">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-3 text-sm text-slate-600">
                  <Calendar size={16} />{" "}
                  <span>
                    জয়েন করেছেন: {userData.joined || "জানুয়ারি ২০২৪"}
                  </span>
                </div>
              </div>
            </div>
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="card bg-white p-6 shadow-md border border-slate-100">
              <h2 className="font-bold text-slate-800 mb-3 flex items-center gap-2">
                <User size={18} className="text-blue-500" /> বায়ো
              </h2>
              <p className="text-slate-600 text-sm leading-relaxed">
                {userData.bio || "প্রফাইল বায়ো নেই।"}
              </p>
            </div>
          </div>
        </div>
