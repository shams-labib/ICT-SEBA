  ...
  return (
    <div className="min-h-screen bg-white py-12 px-4 font-sans">
      ...
      <div className="text-center mb-10">
        ...
        <button className="bg-gradient-to-r from-blue-600 to-purple-500 text-white px-6 py-2 rounded-lg flex items-center mx-auto hover:shadow-lg transition">
      ...
      <div className="max-w-6xl mx-auto bg-[#F5EEFF] rounded-[40px] p-6 md:p-12 flex flex-col lg:flex-row gap-10 items-center">
        ...
        <div className="w-full lg:w-1/2 bg-[#00084D] rounded-3xl overflow-hidden text-white p-6 md:p-8 flex flex-col">
          ...
          <div className="flex flex-col md:flex-row gap-6 mb-6">
            <div className="flex-1">
              ...
              <ul className="text-[11px] space-y-1.5 opacity-90">
                <li>• ঘরে বসে বা ক্লাসে পড়াশোনা</li>
              ...
              <button className="mt-6 bg-[#FFEB3B] text-black font-bold px-6 py-1.5 rounded-md text-sm hover:bg-yellow-500 transition">
                এনরোল করুন
              </button>
            </div>
            ...
            <div className="flex-1 grid grid-cols-2 gap-2">
              ...
              <div className="col-span-1 flex flex-col gap-2">
                <div className="rounded-lg overflow-hidden h-20 border-2 border-yellow-400/30">
                  <img
        ...
        <div className="w-full lg:w-1/2 space-y-6">
          ...
          <p className="text-slate-600 text-sm leading-relaxed">
            ...
            আপনার প্রস্তুতিতে সহায়তা করবে।
          </p>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-y-6 gap-x-4 pt-4">
